...
public class Kernel {
	 ...
	 * @param perception
	 *            A perception calculator.
	 * @param communicationModel
	 *            A communication model.
	 * @param worldModel
	 *            The world model.
	 * @param idGenerator
	 *            An EntityIDGenerator.
	 * @param commandFilter
	 *            An optional command filter. This may be null.
	 * @param termination
	 *            The termination condition.
	 * @param score
	 *            The score function.
	 * @param collector
	 *            The CommandCollector to use.
	 * @throws KernelException
	 *             If there is a problem constructing the kernel.
	 */
	 ...
	 *             If this thread is interrupted during the timestep.
	 * @throws KernelException
	 *             If there is a problem executing the timestep.
	 * @throws LogException
	 *             If there is a problem writing the log.
	 */
