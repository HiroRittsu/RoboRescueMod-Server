...
public class LineOfSightPerception implements Perception, GUIComponent {
	...
	public ChangeSet getVisibleEntities(AgentProxy agent) {
		...
		if (location != null) {
			...
			Collection<StandardEntity> nearby = world.getObjectsInRange(location.first(), location.second(),
					viewDistance);
	...
	private Collection<StandardEntity> findVisible(StandardEntity agentEntity, Point2D location,
