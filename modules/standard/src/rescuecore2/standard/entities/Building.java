...
public class Building extends Area {
	...
	private BooleanProperty ignition; // nullがよく入るので非推奨
	private IntProperty fieryness; // 発火具合 5: 鎮火 8: 全焼
	private IntProperty brokenness; // 崩壊具合
	...
	public Building(EntityID id) {
		...
		registerProperties(floors, ignition, fieryness, brokenness, code, attributes, groundArea, totalArea,
